...
module {
  // OldActor = NewActor of 20260523_220000_AddDocumentVerification.mo
  ...
  // ── OldActor = NewActor of 20260523_220000_AddDocumentVerification ──────────
  ...
  public func migration(old : OldActor) : NewActor {
    {
      ...
      adminRoles         = Map.empty<Principal, AdminRole>();
      renewalHistory     = Map.empty<Principal, List.List<RenewalHistoryEntry>>();
      reminderState      = Map.empty<Principal, ReminderState>();
    };
  };
};

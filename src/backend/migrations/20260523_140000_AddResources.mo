...
module {
  // OldActor = NewActor of 20260523_130000_AddOACMeeting.mo
  ...
  public func migration(old : OldActor) : NewActor {
    {
      ...
      resourceStore = Map.empty<Text, ResourceInternal>();
      allocationStore = Map.empty<Text, PhaseAllocationInternal>();
      idleTimeStore = Map.empty<Text, IdleTimeSettingInternal>();
    };
  };
};

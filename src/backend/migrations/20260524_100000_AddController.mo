...
module {
  // OldActor = NewActor of 20260524_000000_AddAdminAndHistory.mo
  ...
  // ── OldActor = NewActor of 20260524_000000_AddAdminAndHistory ──────────────
  ...
  public func migration(old : OldActor) : NewActor {
    {
      ...
      // Default to the anonymous principal; deployer calls claimController() once
      _controller        = Principal.fromText("2vxsx-fae");
    };
  };
};

...
module {
  // OldActor = NewActor of 20260523_210000_AddSubscriptions.mo
  ...
  // New document verification type
  ...
  type NewActor = {
    ...
    safetyState        : { var nextSafetyId : Nat };
    subscriptions      : Map.Map<Principal, UserSubscription>;
    // New fields for document verification and stripe config
  ...
  public func migration(old : OldActor) : NewActor {
    {
      ...
      documentStore      = Map.empty<Principal, List.List<VerificationDocument>>();
      stripeConfig       = { var secretKey = null };
    };
  };
};

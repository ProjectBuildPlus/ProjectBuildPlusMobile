...
module {
  // OldActor = NewActor of 20260523_100000_AddScenarios.mo
  ...
  public func migration(old : OldActor) : NewActor {
    {
      ...
      settingsState = {
        var rsMeansSettings = old.settingsState.rsMeansSettings;
        var accessControlMode = old.settingsState.accessControlMode;
        var projectManagerId = old.settingsState.projectManagerId;
        var activeCategoryId = null;
        var activeSubtopicId = null;
      };
      scenariosMap = old.scenariosMap;
      shareLinks = Map.empty<Text, ShareLink>();
    };
  };
};
